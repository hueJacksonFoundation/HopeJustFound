...
public class StatusResourceIntTest {
    ...
    private static final LocalDate DEFAULT_APPROVED = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_APPROVED = LocalDate.now(ZoneId.systemDefault());
